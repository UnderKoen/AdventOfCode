...
public class Main {
    ...
    @SneakyThrows
    private static Map<Integer, List<Solution>> getAllSolutions() {
        Set<ClassPath.ClassInfo> classes = ClassPath.from(Main.class.getClassLoader()).getTopLevelClassesRecursive(PACKAGE);
